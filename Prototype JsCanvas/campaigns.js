		...
		"missions": [
			{"type": "conditional",
				...
				"items": [
					...
					{"type": "building", "name": "temple", "x": 16*105, "y": 16*31.5, "faction": "neutral", "color": undefined, "life": undefined, "id": -3},
					{"type": "unit", "name": "soldier", "x": 16*103, "y": 16*30, "faction": "neutral", "color": undefined, "life": undefined, "id": undefined},
					{"type": "unit", "name": "soldier", "x": 16*101, "y": 16*32, "faction": "neutral", "color": undefined, "life": undefined, "id": undefined},
					{"type": "unit", "name": "soldier", "x": 16*103, "y": 16*34, "faction": "neutral", "color": undefined, "life": undefined, "id": undefined},
				],
				"miscs": [
				...
				"triggers": [
					...
					{"class": "main", "type": "conditional",
						"condition": () => isDead(-1),
						"action": () => windowScreen("lose"),
					},
					{"class": "main", "type": "conditional",
						"condition": () => isDead(-2),
						"action": () => windowScreen("win"),
					},
					{"class": "additional", "type": "conditional",
						"condition": () => isDead(-3),
						"action": () => setNotification("Дополнительное задание выполнено"),
					},
				],
			},
		],
