...
let units = {
	list: {
		"worker": {
			iname: "Работяга",
			description: "Работяга хорош, будь как работяга",
			name: "worker",
		...
		"soldier": {
			iname: "Солдат",
			description: "Призовите солдат для борьбы со своим врагом",
			name: "soldier",
...
let buildings = {
	list: {
		"capitol": {
			...
			radiuse: 30,
			sight: 48,
			cost: {"gold": 325, "wood": 120, "metal": 80},
			frames: [],
		},
		"temple": {
			iname: "Храм",
			...
			radiuse: 20,
			sight: 48,
			cost: {"gold": 180, "wood": 60, "metal": 40},
			frames: [],
		},
		"farm": {
			iname: "Ферма",
			description: "Ферма для производства пищи",
			name: "farm",
			src: "images/farm.png",
			hitPoints: 1000,
			width: 32,
			...
			radiuse: 20,
			sight: 30,
			cost: {"gold": 130, "wood": 40, "metal": 10},
			frames: [],
		},
	},
	defaults: {
